...
exports.showJobs = async (req, res, next) => {
    ...
    const keyword = req.query.keyword ? {
        ...
        let setUniqueLocations = [...new Set(locations)]; //remove duplicate locations //...new Set() means we want to have an array //Set() is //Set() is a collection of unique values
