...
exports.showJobs = async (req, res, next) => {
    ...
    const count = await Job.find({...keyword, jobType : categ, location : }).countDocuments(); //...keyword means if keyword is not empty, then use it, otherwise use all jobs //jobType : categ means if categ is not empty, then use it, otherwise use all jobs
