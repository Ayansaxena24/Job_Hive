...
exports.showJobs = async (req, res, next) => {
    ...
    const count = await Job.find({...keyword, jobType : categ}).countDocuments(); //countDocuments() is faster than estimatedDocumentCount() //...keyword means if keyword is not empty, then use it, otherwise use all jobs //
