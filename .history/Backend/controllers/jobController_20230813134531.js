...
exports.showJobs = async (req, res, next) => {
    ...
    const keyword = req.query.keyword ? {
        ...
        let cat = req.params.cat; //category id
    ...
    const count = await Job.find({...keyword, jobType : categ}).countDocuments(); //countDocuments() is faster than estimatedDocumentCount() //...keyword means if keyword is not empty, then use it, otherwise use all jobs //jobType : categ means if categ is not empty, then use it, otherwise use all jobs
