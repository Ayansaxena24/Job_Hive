...
exports.showJobs = async (req, res, next) => {
    ...
    const keyword = req.query.keyword ? {
        ...
        let locationFilter = location !== '' ? location : setUniqueLocations; //if location is not empty, then use it, otherwise use all locations
    ...
    const count = await Job.find({...keyword, jobType : categ, location : loca}).countDocuments(); //...keyword means if keyword is not empty, then use it, otherwise use all jobs //jobType : categ means if categ is not empty, then use it, otherwise use all jobs
