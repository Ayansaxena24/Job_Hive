...
const { createJobType, allJobsType, updateJobType, deleteJobType, createUserJobHistory } = require('../controllers/jobTypeController');
...
// /api/user/jonhistory
router.post('/user/jobhistory', createUserJobHistory6)
