...
const { createCreatorJobHistory, getApplicantInfo } = require('../controllers/userController');
...
//testing
router.get('/jobs/applicants', isAuthenticated, isCreator, getApplicantInfo);
