...
const { allUsers, singleUser, editUser, deleteUser, createUserJobHistory, createCreatorJobHistory, getApplicantInfo } = require('../controllers/userController');
...
// /api/creator/getApplicantInfo
router.post('/creator/changeStatus', isAuthenticated, isCreator, getApplicantInfo, changeStatus)
