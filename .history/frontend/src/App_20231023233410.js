          ...
          <ProSidebarProvider>
            <BrowserRouter>
              <Routes>
                ...
                <Route path="/job/create" element={<CreatorRoute><CreatorSingleJobHOC /></CreatorRoute>} />
                <Route path="/creator/job/:id" element={<CreatorRoute><CreatorDashCreateJobHOC /></CreatorRoute>} />
