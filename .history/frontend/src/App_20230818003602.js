...
const UserJobHistoryHOC = Layout(UserJobHistoryDashboard); //instead of userdashboard we will see userdashboardHOC
          ...
          <ProSidebarProvider>
            <BrowserRouter>
              <Routes>
                ...
                <Route path="/user/jobs"element={<UserRoute><UserDashboardHOC /></UserRoute>}/>
