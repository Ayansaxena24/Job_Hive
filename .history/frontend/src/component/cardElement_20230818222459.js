...
const CardElement = ({ jobTitle, description, category, location, id }) => {
    ...
    return (
        <div className='hover:shadow-md hover:shadow-blue-100 duration-300 ease-in-out'>
        <Card className='bg-gradient-to-b from-gray-900 to-gray-600 bg-gradient-to-r hover:bg-gradient-to-tr hover:from-gray-900 hover:to-gray-600 hover:bg-gradient-to-r duration-300 ease-in-out' sx={{ minWidth: 275, mb: 3, mt: 3}}>
