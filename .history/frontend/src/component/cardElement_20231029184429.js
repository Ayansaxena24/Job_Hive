...
const CardElement = ({ company, jobTitle, salary, description, category, location, id, creatorId, isCreator }) => {
    ...
    return (
        ...
        <div className={`p-2 my-2 rounded-md ${mode === 'dark' ? 'bg-gradient-to-b from-gray-900 to-gray-600 bg-gradient-to-r hover:bg-gradient-to-tr hover:from-gray-900 hover:to-gray-600 hover:bg-gradient-to-r duration-300 ease-in-out' : 'bg-gradient-to-l from-[#00f260] to-[#0575e6] text-black border-2'}`} sx={{ minWidth: 275, mb: 3, mt: 3}}>
