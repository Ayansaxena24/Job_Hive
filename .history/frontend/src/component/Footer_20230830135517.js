...
const Footer = () => {
    ...
    return (
        <>
            <Box 
            className = {`bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-200 via-slate-600 to-indigo-200 h-[70px] flex justify-center items-center`}
