...
const StatComponent = ({ value, icon, description, money }) => {
    ...
    return (
        <>
            ...
            >
                <div className={`w-screen ${mode === 'light' ? 'bg-gradient-to-b from-gray-900 to-gray-600 bg-gradient-to-r hover:bg-gradient-to-tr hover:from-gray-900 hover:to-gray-600 hover:bg-gradient-to-r duration-300 ease-in-out' : 'bg-gray-400 text-black border-2 border-gray-100'}`}>
                <CardContent >
