...
const CardElement = ({ jobTitle, description, category, location, id }) => {
    ...
    return (
        ...
        <Card className='bg-gradient-to-r from-indigo-500 ...' sx={{ minWidth: 275, mb: 3, mt: 3}}>

            <CardContent >
                <Typography sx={{ fontSize: 15, color: "white", fontWeight: 500 }} gutterBottom>
                    <IconButton><LocationOnIcon sx={{ color: "white", fontSize: 18 }} /></IconButton> {location}
                </Typography>
