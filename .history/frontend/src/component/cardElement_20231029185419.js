...
const CardElement = ({ company, jobTitle, salary, description, category, location, id, creatorId, isCreator }) => {
    ...
    return (
        ...
        <div className={`text-white p-2 my-2 rounded-md ${mode === 'dark' ? 'bg-gradient-to-b from-gray-900 to-gray-600 bg-gradient-to-r hover:bg-gradient-to-tr hover:from-gray-900 hover:to-gray-600 hover:bg-gradient-to-r duration-300 ease-in-out' : 'bg-[conic-gradient(at_left,_var(--tw-gradient-stops))] from-indigo-900 via-indigo-400 to-indigo-900 text-white'}`} sx={{ minWidth: 275, mb: 3, mt: 3}}>
            ...
            <CardContent className='flex justify-between'>
                ...
                <Typography
                className={`pl-4 ${mode === 'dark' ? 'text-white' : 'text-black'}`}  
                // sx={{ mb: 1.5 ,color: "whitesmoke"}}
                >
                    {salary}
                </Typography>
