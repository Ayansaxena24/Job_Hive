...
const LogIn = () => {
    ...
    return (
        <>
            ...
            // sx={{ height: '81vh', display: "flex", alignItems: "center", justifyContent:border-collapse"center" }}
            >
                <video src={face} className='absolute w-[67%]' autoPlay='true' loop muted/>

                <Box onSubmit={formik.handleSubmit} component="form" 
                className="relative flex justify-center p-[24px] bg-white border-1 w-[35%] border-collapse
