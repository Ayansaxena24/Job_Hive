...
const CreatorDashCreateJob = () => {
    ...
    return (
        <>
            ...
            className="h-[100%] flex items-center justify-center pt-2 ${mode==='dark' ? 'bg-gradient-to-l from-gray-700 via-gray-900 to-black' : 'bg-white'}}"
            >


                <Box onSubmit={formik.handleSubmit} component="form"
                className={`relative flex p-[24px] border-2 w-[35%] rounded-2xl ${mode==='dark' ? 'border-white bg-black' : 'border-black bg-white'}`}
                >
