...
import { creatorJobAction } from '../../Redux/actions/userAction';
    ...
    return (
        <>
            ...
            >
                ...
                className={`relative flex p-[24px] border-[1px] w-[35%] rounded-2xl ${mode==='dark' ? 'border-gray-600 bg-[conic-gradient(at_top_right,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black' : 'border-black bg-white'}`}
                >
                    ...
                    <Typography variant="h5" component="h2" sx={{ pb: 3 }}>
                        ...
                        <Button fullWidth variant="contained" type='submit' onClick={createAJob} >Create job</Button>
                    </Box>
                </Box>
            </Box>
