        ...
        <>
            <Box >
                ...
                <Box sx={{ pb: 2, display: "flex", justifyContent: "right" }}>
                    <Button variant='contained' color="success" startIcon={<AddIcon />}><Link style={{ color: "white", textDecoration: "none" }} to="/admin/user/create">Create Job</Link></Button>
                </Box>
...
export default CreatorDashUsers