    ...
    return (
        <>
            ...
            >
                ...
                className={`relative flex p-[24px] border-[1px] w-[35%] rounded-2xl ${mode==='dark' ? 'border-bg-[conic-gradient(at_top_right,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black bg-[conic-gradient(at_top_right,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black' : 'border-black bg-white'}`}
                >
