  ...
  const columns = [
...

    {
      ...
      renderCell: (values) => (
        ...
        >
          <button onClick={values.row.resumeLink ? window.open(values.row.resumeLink) : )} className="bg-gradient-to-t from-gray-700 via-gray-900 to-gray-700 rounded-2xl px-6 py-1 duration-300 ease-in-out hover:bg-gradient-to-b hover:from-gray-900 hover:via-gray-700 hover:to-gray-900" variant="contained">Resume</ button>
