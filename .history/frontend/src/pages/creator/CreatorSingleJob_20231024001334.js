    ...
    return (
        <div className={`${mode === 'light' ? 'bg-white min-h-screen' : 'bg-gradient-to-t from-gray-700 via-gray-900 to-black border-1'}`}>
            ...
            >
                ...
                <Box className="absolute top-16 left-0 w-full bg-green-300">
