...

        {
            ...
            renderCell: (values) => (
                <Box sx={{ display: "flex", justifyContent: "space-between", width: "170px" }}>
                    <Button variant="contained"><Link style={{ color: "white", textDecoration: "none" }} to={`/creator/edit/job/${values.row._id}`}>Edit</Link></ Button>
    ...
    return (
        <Box >
            ...
            <Box sx={{ pb: 2, display: "flex", justifyContent: "right" }}>
                <Button variant='contained' color="success" startIcon={<AddIcon />}> <Link style={{ color: "white", textDecoration: "none" }} to="/creator/job/create">Create Job</Link></Button>
            </Box>
            <Paper
...
export default CreatorDashJobs