    ...
    <>
      ...
      >
        ...
        <div className={`${mode === "dark" ? "dark:bg-gray-800" : "bg-white"}`}>
          ...
          >
            <Box className={`${mode === "light" ? "bg-gradient-to-t from-indigo-900 via-indigo-400 to-indigo-900" : ""}`} sx={{ flex: 2, p:2 }}>
              <Card className={`${mode === "light" ? "bg-gradient-to-r from-[#d5e6e4] to-[#cfead9]" : ""}`} sx={{ minWidth: 150, mb: 3, mt: 3, p: 2 }}>
                <Box sx={{ pb: 2 }}>
                  <Typography
