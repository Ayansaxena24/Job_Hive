    ...
    <div className="overflow-hidden">
      ...
      >
        ...
        >
          ...
          <CardContent className={` min-h-[650px] z-10  ${mode === 'dark' ? 'bg-[#1E1E1E]' : 'bg-gray-300 bg-gradient-to-r from-[#3c1053] to-[#ad5389]' }`}>
            <div>
              ...
              <div className="pt-4 flex flex-row">
                ...
                <Tilt options = {defaultOptions} className={`relative pl-10 border-1 border-blue-200 rounded-2xl w-full pt-4 ${mode === 'dark' ? 'bg-gradient-to-r from-[#001510] to-[#00bf8f]' : ' bg-gradient-to-r from-[#a0467c] to-[#7327a5]'}`}>
                  ...
                  <Typography
                    ...
                    sx={{ color: "#fafafa" }}
                  >
                    XII Percentage: {user && user.marksTwelth ? user.marksTwelth : "NA"}%
                  </Typography>
                  </div>
                  <hr className="absolute left-21 scale-95 w-full bottom-14 bg-white p-0.1 mb-2"></hr>
                  ...
                  <Typography
                    ...
                    className={` cursor-pointer duration:300 ease-in-out ${mode === 'dark' ? 'hover:text-green-500' : 'hover:text-purple-500'}`}
                  >
                    {user && user.resumeLink ? "Show Resume" : "Not submitted yet"}
                  </Typography>
                  </div>
                </Tilt>
              </div>
