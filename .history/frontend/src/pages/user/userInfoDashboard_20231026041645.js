          ...
          <CardContent className={` min-h-[600px] z-10  ${mode === 'dark' ? 'bg-[#1E1E1E]' : 'bg-gray-300 bg-gradient-to-r from-[#3c1053] to-[#ad5389]' }`}>
            <div>
              ...
              <div className="pt-4 flex flex-row">
                ...
                <Tilt options = {defaultOptions} className={`border-1 border-blue-200 rounded-2xl w-full pl-4 pt-4 ${mode === 'dark' ? 'bg-gradient-to-r from-[#001510] to-[#00bf8f]' : ' bg-gradient-to-r from-[#ff0099] to-[#493240]'}`}>
                  <Typography
                    variant="h6"
                    component="div"
                    sx={{ color: "#fafafa" }}
