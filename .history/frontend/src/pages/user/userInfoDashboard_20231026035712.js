    ...
    <div className="overflow-hidden">
      ...
      >
        ...
        >
          ...
          <CardContent className={` min-h-[600px] z-10  ${mode === 'dark' ? 'bg-[#1E1E1E]' : '' }`}>
            <div>
              ...
              <div className="pt-4 flex flex-row">
                ...
                <Tilt options = {defaultOptions} className="border-2 border-blue-4200 rounded-2xl w-full pl-4 pt-4 bg-gradient-to-r from-[#001510] to-[#00bf8f]">
                  <Typography
                    variant="h6"
                    component="div"
                    sx={{ color: "#fafafa" }}
