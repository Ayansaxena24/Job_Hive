    ...
    <div className="overflow-hidden">
      ...
      >
        ...
        >
          ...
          <CardContent className="min-h-[550px] z-10 mb-10 bg-gradient-to-r from-sky-500 to-teal-100">
            <div>
              ...
              <div className="pt-4 flex flex-row">
                ...
                <div className="border-2 border-gray-400 rounded-2xl w-full pl-4 pt-4 bg-gradient-to-r from-maroon-800 to-russian-violet">
                  <Typography
                    variant="h6"
                    component="div"
                    sx={{ color: "#fafafa" }}
