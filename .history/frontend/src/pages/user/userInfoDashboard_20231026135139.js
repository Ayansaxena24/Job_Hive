          ...
          <CardContent className={` min-h-[650px] z-10  ${mode === 'dark' ? 'bg-[#1E1E1E]' : 'bg-gray-300 bg-gradient-to-r from-[#3c1053] to-[#ad5389]' }`}>
            <div>
              ...
              <div className="pt-4 flex flex-row">
                ...
                <Tilt options = {defaultOptions} className={`mpl-10 border-1 border-blue-200 rounded-2xl w-full pl-4 pt-4 ${mode === 'dark' ? 'bg-gradient-to-r from-[#001510] to-[#00bf8f]' : ' bg-gradient-to-r from-[#a0467c] to-[#7327a5]'}`}>
