...
const UserInfoDashboard = () => {
    ...
    return (
        <div className='overflow-hidden'>
            ...
            >
                <Card
                className='relatmin-w-[275] bg-gradient-to-b from-gray-900 to-gray-600 bg-gradient-to-r hover:bg-gradient-to-tr hover:from-gray-900 hover:to-gray-600 hover:bg-gradient-to-r duration-300 ease-in-out' 
