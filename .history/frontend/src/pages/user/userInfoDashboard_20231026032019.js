    ...
    <div className="overflow-hidden">
      ...
      >
        ...
        >
          ...
          <CardContent className="min-h-[550px] z-10 mb-10 "bg-gradient-to-r from-teal-400 to-teal-900>
            <div>
              ...
              <div className="pt-4 flex flex-row">
                ...
                <div className="border-2 border-gray-400 rounded-2xl w-full pl-4 pt-4">
                  <Typography
                    variant="h6"
                    component="div"
                    sx={{ color: "#fafafa" }}
