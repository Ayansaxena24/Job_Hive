...
const LogIn = () => {
    ...
    return (
        <>
            <Navbar />
            <Box className="relative" sx={{ height: '81vh', display: "flex", alignItems: "center", justifyContent: "center" }}>
                <video src={face} autoPlay muted loop className='absolute w-[100%] h-[100%]'/>
