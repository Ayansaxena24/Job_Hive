                    ...
                    <Container className="flex justify-center items-center" sx={{ pt: '30px' }}>
                        ...
                        >
                            <Box sx={{ flex: 4, py: 2 }}>

                                {
                                    loading ? <LoadingBox /> :
                                        ...
                                        <Card className='relative h-[500px] w-[1100px] text-3xl'>
                                            <CardContent className='bg-gradient-to-r from-[#a0467c] via-[#7327a5] to-[#a0467c] h-full flex flex-col '>
                                                ...
                                                <Typography variant="body2">
                                                    <Box component="span" className='text-3xl' sx={{ fontWeight: 700 }}>Salary</Box>: ${singleJob && singleJob.salary}
                                                </Typography>
                                                <Typography variant="body2">
                                                    <Box component="span" className='text-3xl' sx={{ fontWeight: 700 }}>Category</Box>: {singleJob && singleJob.jobTypeName ? singleJob.jobTypeName : "No category2"}
                                                </Typography>
                                                <Typography variant="body2">
                                                    <Box component="span" className='text-3xl' sx={{ fontWeight: 700 }}>Location</Box>: {singleJob && singleJob.location}
                                                </Typography>
                                                <Typography variant="body2" sx={{ pt: 0 }}>
                                                <Box component="span" className='text-3xl' sx={{ fontWeight: 700 }}>Job description</Box>: {singleJob && singleJob.description}
                                                </Typography>
                                                </div>
                                            </CardContent>
                            ...
                            <Box className="flex justify-center pr-12">
                                <Button onClick={applyForAJob} className='hover:shadow-lg shadow-white bg-gradient-to-r from-[#ad5389] via-[#691c93] to-[#ad5389] duration-300 ease-in-out w-[1100px] h-20' sx={{ fontSize: "15px" }} variant='contained'>Apply for this Job</Button>
                            </Box>
