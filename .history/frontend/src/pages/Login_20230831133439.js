    ...
    return (
        <>
            ...
            >
                ...
                <div onSubmit={formik.handleSubmit} component="form" className='w-[30%] absolute left-10 top-20 bg-gray-800 rounded-lg'
                // className="form_style border-style" sx={{backgroundColor:"black"}}
                >
                    <Box
                    className={`flex flex-col items-center w-[100%] px-4 pb-4 rounded-xl ${mode === "dark" ? "dark:bg-gray-800" : "bg-white"}`} 
