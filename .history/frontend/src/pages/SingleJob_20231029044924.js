                    ...
                    <Container className="flex justify-center items-center" sx={{ pt: '30px' }}>
                        ...
                        >
                            ...
                            <Box className="flex justify-center pr-12">
                                <Button onClick={applyForAJob} className='bg-gradient-to-r from-[#ad5389] via-[#3c1053] to-[#ad5389] w-[1100px] h-20' sx={{ fontSize: "15px" }} variant='contained'>Apply for this Job</Button>
                            </Box>
