                    ...
                    <Container className="flex justify-center items-center" sx={{ pt: '30px' }}>
                        ...
                        >
                            ...
                            <Box className="flex justify-center pr-12">
                                <Button onClick={applyForAJob} className='hover:shadow-lg hover:shadow-blue-100 border-gray-100 border-4 hover:scale-105 bg-gradient-to-r from-[#ad5389] via-[#691c93] to-[#ad5389] duration-300 ease-in-out w-[1100px] h-20' sx={{ fontSize: "15px" }} variant='contained'>Apply for this Job</Button>
                            </Box>
