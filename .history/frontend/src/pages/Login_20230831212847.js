    ...
    return (
        <>
            ...
            >
                ...
                className={`${mode === '' ? 'relative flex justify-center p-[24px] bg-white border-1 w-[35%] rounded-lg' : 'relative flex justify-center p-[24px] bg-[#121212] border-1 w-[35%] rounded-lg'}`} 
