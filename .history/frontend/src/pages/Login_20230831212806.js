    ...
    return (
        <>
            ...
            >
                ...
                className={`${mode === 'light' ? 'relative flex justify-center p-[24px] bg-gradient-to-t bg-from-gray-700 via-gray-900 to-black border-1 w-[35%] rounded-lg' : 'relative flex justify-center p-[24px] bg-[#121212] border-1 w-[35%] rounded-lg'}`} 
