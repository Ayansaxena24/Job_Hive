                ...
                <Box className="absolute top-16 left-0 w-full bg-green-900 h-screen">
                    <Container className="flex justify-center items-center" sx={{ pt: '30px' }}>
                        ...
                        >
                            ...
                            <Box className="flex justify-center pr-12 py-4">
                                <Button onClick={applyForAJob} className='w-[1100px]' sx={{ fontSize: "13px" }} variant='contained'>Apply for this Job</Button>
                            </Box>
