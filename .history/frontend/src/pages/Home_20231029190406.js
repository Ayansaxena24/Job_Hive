        ...
        <div className={`${mode === "dark" ? "dark:bg-gray-800" : "bg-white"}`}>
          ...
          >
            <Box className={`${mode === "light" ? "bg-gradient-to-r from-[#3c1053] to-[#ad5389]" : ""}`} sx={{ flex: 2, p:2 }}>
              <Card className={`${mode === "light" ? "bg-gradient-to-r from-[#3c1053] to-[#ad5389]" : ""}`} sx={{ minWidth: 150, mb: 3, mt: 3, p: 2 }}>
                <Box sx={{ pb: 2 }}>
                  <Typography
            ...
            <Box className={`${mode === "light" ? "bg-[conic-gradient(at_left,_var(--tw-gradient-stops))] from-indigo-900 via-indigo-400 to-indigo-900" : ""}`} sx={{ flex: 5, p: 2 }}>
              {loading ? (
                <LoadingBox />
              ) : jobs && jobs.length === 0 ? (
                <>
