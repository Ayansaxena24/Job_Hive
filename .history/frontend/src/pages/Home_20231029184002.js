    ...
    <>
      ...
      >
        ...
        <div className={`${mode === "dark" ? "dark:bg-gray-800" : "bg-white"}`}>
          ...
          >
            <Box className={`${mode === "light" ? "bg-gradient-to-r from-[#1c92d2] to-[#f2fcfe]" : ""}`} sx={{ flex: 2, pl: 2, pt:2, pb:2 }}>
            ...
            <Box className={`${mode === "light" ? "bg-gradient-to-r from-[#1c92d2] to-[#f2fcfe]" : ""}`} sx={{ flex: 5, pr: 2, pt:2, pb:2 }}>
              {loading ? (
                <LoadingBox />
              ) : jobs && jobs.length === 0 ? (
                <>
