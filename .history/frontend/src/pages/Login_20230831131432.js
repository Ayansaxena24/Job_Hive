...
const LogIn = () => {
    ...
    return (
        <>
            <Navbar />
            <Box className="relative bg-black" sx={{ height: '81vh', display: "flex", alignItems: "center", justifyContent: "center" }}>
                <video src={face} autoPlay muted loop className='absolute right-0 w-[80%] h-[80%]'/>
                <Box onSubmit={formik.handleSubmit} component="form" className="form_style border-style left-0 absolute" >
