                                    ...
                                    loading ? <LoadingBox /> :
                                        ...
                                        <Card className='relative'>
                                            <CardContent>
                                                ...
                                                <Typography variant="body2">
    <Box component="span" sx={{ fontWeight: 700 }}>Category</Box>: {singleJob && singleJob.length > 0 ? singleJob[0].jobType ? singleJob[0].jobType.jobTypeName : "No category" : "No category"}
</Typography>
