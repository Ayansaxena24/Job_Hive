...
return (
    <>
        <Sidebar className='bg-gradient-to-r from-gray-700 via-gray-900 to-black' backgroundColor="" style={{ borderRightStyle: "none" }}>
                    ...
                    >
                        {
                            userInfo && userInfo.role === 1 ?
                                <>
                                    ...
                                    <MenuItem component={<Link to="/user/info" />} icon={<CategoryIcon />}> Admin Profile </MenuItem>
                                </> :
                                 (
                                    userInfo && userInfo.role === 2 ?
                                    <>
                                        <MenuItem component={<Link to="/creator/dashboard" />} icon={<DashboardIcon />}> Dashboard </MenuItem>
                                        <MenuItem component={<Link to="/creator/applicants" />} icon={<GroupAddIcon />}> Applicants </MenuItem>
                                        <MenuItem component={<Link to="/creator/jobs" />} icon={<WorkIcon />}> Jobs </MenuItem>
                                        <MenuItem component={<Link to="/creator/category" />} icon={<CategoryIcon />}> Category </MenuItem>
                                        <MenuItem component={<Link to="/user/info" />} icon={<CategoryIcon />}> Creator Profile </MenuItem>
                                    </> :
                                    <>
