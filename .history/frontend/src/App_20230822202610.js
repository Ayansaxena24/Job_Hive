...
const DashUsersHOC = Layout(adminDashboard); //instead of userdashboard we will see userdashboardHOC
          ...
          <ProSidebarProvider>
            <BrowserRouter>
              <Routes>
                ...
                <Route path="/admin/users" element={<AdminRoute><AdminDashboardHOC /></AdminRoute>} />
