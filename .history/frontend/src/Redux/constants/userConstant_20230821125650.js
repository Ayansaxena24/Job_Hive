...
export const USER_APPLY_JOB_SUCCESS = "USER_APPLY_JOB_REQUEST";
export const USER_APPLY_JOB_FAIL = "USER_APPLY_JOB_REQUEST";
export const USER_APPLY_JOB_RESET = "USER_APPLY_JOB_REQUEST";