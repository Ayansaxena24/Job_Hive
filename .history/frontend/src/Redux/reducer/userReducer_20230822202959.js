import { ALL_USER_LOAD_REQUEST, ALL_USER_LOAD_SUCCESS } from "../constants/jobConstants"
import { USER_LOAD_FAIL, USER_LOAD_REQUEST, USER_LOAD_RESET, USER_LOAD_SUCCESS, USER_LOGOUT_FAIL, USER_LOGOUT_REQUEST, USER_LOGOUT_RESET, USER_LOGOUT_SUCCESS, USER_SIGNIN_FAIL, USER_SIGNIN_REQUEST, USER_SIGNIN_RESET, USER_SIGNIN_SUCCESS } from "../constants/userConstant"
...
//all users reducer
export const allUserJobReducer = (state = {user : null}, action) => {
    switch (action.type) {
