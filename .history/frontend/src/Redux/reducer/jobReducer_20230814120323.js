import { JOB_LOAD_REQUEST, JOB_LOAD_SUCCESS } from "../constraints/jobConstraints";
...
export const loadJobReducer = (
  ...
  switch (action.type) {
    ...
    case JOB_LOAD_FAI: //if request is successful, loading is false and jobs are returned
      return {
        loading: false,
