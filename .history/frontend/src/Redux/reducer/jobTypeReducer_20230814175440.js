import { JOB_TYPE_LOAD_REQUEST, JOB_TYPE_LOAD_SUCCESS } from "../constants/jobTypeConstants";
...
export const loadJobTypeReducer = (
    ...
    switch (action.type) {
      ...
      case JOB_TYPE_LOAD_FAI: //if request is successful, loading is false and jobs are returned
        return {
          loading: false,
