...
export const deleteUserReducer = (state = { /* initial state */ }, action) => {
  ...
  //GET_APPLICANT_INFO_REDUCER
    export const getSingleApplicantReducer = (state = { /* initial state */ }, action) => {
        ...
        case GET_APPLICANT_INFO_REQUEST:
